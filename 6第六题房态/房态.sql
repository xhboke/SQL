	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					SET @SQL = CONCAT('UPDATE #Temp SET F',CAST(@F AS varchar),'=''ռ��''','WHERE ROOM_ID = ',CAST((@A+@B) AS varchar) );
					EXEC(@SQL);
				END
				/** ���� Ԥ����Ϣ */ /** Ԥ�� Ԥ����Ϣ */
				...
				BEGIN
					SET @SQL = CONCAT('UPDATE #Temp SET F',CAST(@F AS varchar),'=''Ԥ��''','WHERE ROOM_ID = ',CAST((@A+@B) AS varchar) );
					EXEC(@SQL);
				END
				...
				ELSE
				BEGIN
					SET @SQL = CONCAT('UPDATE #Temp SET F',CAST(@F AS varchar),'=''����''','WHERE ROOM_ID = ',CAST((@A+@B) AS varchar) );
					EXEC(@SQL);
				END
