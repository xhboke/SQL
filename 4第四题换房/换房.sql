...
CREATE PROCEDURE P_CHANGE_ROOM 
	@CHECKIN_ID INT, /** 入住号 */
	@ROOM_ID INT,  /** 准备更换的房间号 */
	@CHANGE_DATE DATE /** 更换的日期 */
AS
BEGIN
	DECLARE @CHANGE_ID INT;	/** 换房标识号 */
	DECLARE @CHANGE_BEFORE_ROOM_ID INT; /** 换房前的房间号 */
	DECLARE @CHANGE_BEFORE_DATE DATE; /** 换房前的入住日期 */
